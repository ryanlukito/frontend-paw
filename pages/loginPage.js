...
const loginPage = () => {
  return (
    <section className="w-screen h-screen pl-[6vw] pt-[3vw] bg-gradient-to-r from-[#D0BFF9E5] to-[#2B056BE5]">
        ...
        <div className="w-[80vw] h-[34.115vw] flex bg-[#F7E5F7] rounded-[1.5vw] mt-[2vw] items-center">
          <div className="w-[35vw] h-[32vw] flex flex-col justify-around items-center">
              ...
              <div className="flex flex-col">
                <label className="font-bold text-purple-900 text-[1.042vw] mb-[1vw]">Username</label>
                <input 
                  type="email"
              ...
              <div className="flex flex-col">
                <label className="font-bold text-purple-900 text-[1.042vw] mb-[1vw]">Password</label>
                <input 
                  type="email"
          ...
          <div className="w-[45vw] h-full flex flex-col justify-center items-start ml-[2vw] relative">
              <h1 className="text-[4.167vw] text-[#43066C] font-bold leading-none absolute top-0">When Style <br/>Meets<br/> Comfort</h1>
              <Image

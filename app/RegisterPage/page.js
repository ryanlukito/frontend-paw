...
const registerPage = () => {
  return (
    <section className="w-full min-h-screen p-[3vw] aspect-ratio[1920/1080] bg-[#F2EDFCE5] flex flex-row items-center justify-center">
                ...
                <div className="w-[36.88vw] h-[37.774vw] flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col">
                            ...
                            <input 
                                type="text" 
                                placeholder=""
                                className="w-[17.147vw] h-[2.804vw] drop-shadow-lg rounded-[0.5vw] border-[0.04vw] border-[#9B9595] px-[0.5vw]"
                            />
                        </div>
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input 
                            type="text" 
                            placeholder=""
                            className="w-[36.8vw] h-[2.804vw] drop-shadow-lg rounded-[0.5vw] border-[0.04vw] border-[#9B9595] px-[0.5vw]"
                        />
                    </div>
                    <div className="flex flex-col">
